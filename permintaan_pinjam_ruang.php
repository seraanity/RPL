...
$query = "SELECT dp.id_pinjam_ruang, s.nama_siswa, r.nama_ruang, r.desc_ruang, dp.jumlah, dp.tgl_pinjam, dp.tgl_kembali, dp.status 
          FROM data_pinjam_ruang dp 
          JOIN ruang r ON dp.id_ruang = r.id_ruang
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        <tr>
                                            <td><?php echo $d1['id_pinjam_ruang']; ?></td>
                                            <td><?php echo $d1['nama_siswa']; ?></td>
                                            <td><?php echo $d1['nama_ruang']; ?></td>
                                            ...
                                            <td class="text-center">
                                                <form action="approve_request_ruang.php" method="post">
                                                    <input type="hidden" name="id" value="<?php echo $d1['id_pinjam_ruang']; ?>">
                                            ...
                                            <td class="text-center">
                                                <form action="reject_request.php" method="post">
                                                    <input type="hidden" name="id_pinjam" value="<?php echo $d1['id_pinjam_ruang']; ?>">
