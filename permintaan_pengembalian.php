        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Permintaan Pengembalian</h1>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <div class="text-right">
                                        <div class="pull-left panel-title">Permintaan Pengembalian</div>
                                ...
                                <div class="panel-body">
                                    <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        <?php
                                            $sql = "SELECT
                                                data_pinjam.id_pinjam,
                                                siswa.nama_siswa,
                                                barang.nama_barang,
                                                data_pinjam.jumlah,
                                                data_pinjam.tgl_pinjam, 
                                                data_pinjam.tgl_kembali
                                                FROM 
                                                    data_pinjam
                                                JOIN 
                                                    barang ON data_pinjam.id_barang = barang.id_barang
                                                JOIN 
                                                    siswa ON data_pinjam.id_siswa  = siswa.id_siswa";
                                        $result = mysqli_query($conn, $sql);
                                        $nomor_urut = 0;
                                        if(mysqli_num_rows($result) > 0){
                                            while($row = mysqli_fetch_assoc($result)){
                                                $nomor_urut ++;
                                                $data_id_pinjam = $row['id_pinjam'];
                                                $data_nama_siswa = $row['nama_siswa'];
                                                $data_nama_barang = $row['nama_barang'];
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $data_nama_barang; ?></td>
