...
$query = "SELECT dpr.id_pinjam_ruang, s.nama_siswa, r.nama_ruang, r.desc_ruang, dpr.jumlah, dpr.tgl_pinjam, dpr.tgl_kembali, dpr.status 
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Permintaan Pengembalian Ruang</h1>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <div class="text-right">
                                        <div class="pull-left panel-title">Permintaan Pengembalian Ruang</div>
                                ...
                                <div class="panel-body">
                                    <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $data_tglkembali;?></td>
                                            <td class="text-center">
                                                <form action="approve_request_ruang.php" method="post">
                                                    <input type="hidden" name="id" value="<?php echo $data_id_pinjam; ?>">
